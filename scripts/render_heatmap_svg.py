...
# Coffee Style: empty -> brightest crema.
PALETTE = ["#2A1F1B", "#5C3A21", "#8B5A33", "#B87333", "#D98A4C", "#F5B041"]
...
""".strip()
    ...
    parts.append(f'<text x="{canvas_w/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
                 f'text-anchor="middle">caffeinatedbyte@github: ~/contributions --graph</text>')
